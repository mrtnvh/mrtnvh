...
<figure>
  ...
  <button class="reset outline" style="height:800px; width: 100%;" data-template-id="dyqxBVx">
    Load from CodePen
  </button>
...
<figure>
  ...
  <button class="reset outline" style="height:800px; width: 100%;" data-template-id="KKxeLrX">
    Load from CodePen
  </button>
  <figcaption style="display:flex; align-items:baseline; justify-content: start;">
    <span>
